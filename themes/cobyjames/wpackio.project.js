...
module.exports = {
	// Project Identity
	appName: 'cobyjames', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'cobyjames', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	...
	files: [
		{
			...
			entry: {
		     ...
		     // global namespace pollutions 😉
				main: ['./src/theme.js'], // Or an array of string (string[])
			},
		...
		},
		{
			...
			entry: {
		     ...
		     // code splitting automatically. When using ES6 modules, forget
		     // global namespace pollutions 😉
				main: ['./src/customizer.js'], // Or an array of string (string[])
			},
			// Extra webpack config to be passed directly
			webpackConfig: undefined,
		},
